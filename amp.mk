...
ARCHLDSCRIPT	:= -T"E:/monitor_program_intel_quartusprime/University_Program/Monitor_Program/build/altera-socfpga-hosted.ld"
ASFLAGS		:= $(ARCHASFLAGS)
...
# Files
SYS_FILE_SOF			:= "E:/monitor_program_intel_quartusprime/University_Program/Computer_Systems/DE1-SoC/DE1-SoC_Computer/verilog/DE1_SoC_Computer.sof"
SYS_SCRIPT_JTAG_ID		:= --script="E:/monitor_program_intel_quartusprime/University_Program/Monitor_Program/bin/jtag_instance_check.tcl"
SYS_FILE_ARM_PL			:= --preloader "E:/monitor_program_intel_quartusprime/University_Program/Monitor_Program/arm_tools/u-boot-spl.de1-soc.srec"
SYS_FLAG_ARM_PL_ADDR	:= --preloaderaddr 0xffff13a0

############################################
# Compilation Targets

COMPILE: DINOBEAUTY.srec

DINOBEAUTY.srec: DINOBEAUTY.axf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@
...
CLEAN: 
	$(RM) DINOBEAUTY.srec DINOBEAUTY.axf $(OBJS)
